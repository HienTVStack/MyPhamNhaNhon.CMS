      ...
      {loading ? (
        ...
        <Paper elevation={0}>
          ...
          <Stack p={3}>
            ...
            <Stack spacing={3} pt={2} direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
              ...
              <Autocomplete
                ...
                renderOption={(props, option, { selected }) => (
                  <li {...props}>
                    <Checkbox icon={<Iconify icon="bx:checkbox" />} checkedIcon={<Iconify icon="bx:checkbox-checked" />} checked={selected} />
                    {option.name}
                  </li>
                )}
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField fullWidth {...params} placeholder={"Type"} label={"Type"} error={nameProductErr !== ""} helperText={nameProductErr} />
                )}
              />
              <TextField
                placeholder="Num"
            ...
            <Stack pt={2}>
              <Typography variant="body1" component={"h3"} name="description" value={description} onChange={(e) => setDescription(e.target.value)}>
                Ghi chú
              </Typography>
        ...
        <Box sx={style}>
          ...
          {supplierList.length > 0 &&
            supplierList.map((item, index) => (
              <PopupInfo key={index} id={item._id} name={item.name} address={item.address} phone={item.phone} selectItem={handleSelectSupplier} />
            ))}
